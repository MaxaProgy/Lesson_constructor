...
class Menu(QMainWindow):
    def __init__(self):
        ...
        class_characteristic = [item.name_class_characteristic for item in
                                self.session.query(ClassCharacteristic).all()]
...
# Заставка
splash = QSplashScreen(QtGui.QPixmap('data/image/фоны/заставка.png').scaled(*ex.normal.normal_prop_xy(1544, 900)),
